...
CREATE TABLE USER_INFO_ROLE (
	...
	CONSTRAINT ROLE_USER_INFO_FK FOREIGN KEY (USER_INFO_FK) REFERENCES USER_INFO(USER_PK),
	CONSTRAINT ROLE_USER_INFO_ROLE_FK FOREIGN KEY (ROLE_FK) REFERENCES ROLE(ROLE_PK)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE MODEL (
	...
	CONSTRAINT MODEL_MANUFACTURER_FK FOREIGN KEY (MANUFACTURER_FK) REFERENCES MANUFACTURER(MANUFACTURER_PK)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE CAR (
	 ...
	 PRICE INT(9),
	 PHOTO LONGBLOB,
	 AVAILABE BIT DEFAULT 0,
     PRIMARY KEY (CAR_PK),
	 UNIQUE (REGISTRATION_NUMBER),
	 CONSTRAINT CAR_MODEL_FK FOREIGN KEY (MODEL_FK) REFERENCES MODEL(MODEL_PK),
	 CONSTRAINT CAR_VEHICLETYPE_FK FOREIGN KEY (VEHICLETYPE_FK) REFERENCES VEHICLETYPE(VEHICLETYPE_PK),
	 CONSTRAINT CAR_TRANSMISSION_FK FOREIGN KEY (TRANSMISSION_FK) REFERENCES TRANSMISSION(TRANSMISSION_PK)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE RENTAL (
	...
	CONSTRAINT RENTAL_CAR_FK FOREIGN KEY (CAR_FK) REFERENCES CAR(CAR_PK),
	CONSTRAINT RENTAL_USER_FK FOREIGN KEY (USER_FK) REFERENCES USER_INFO(USER_PK),
	CONSTRAINT RENTAL_STATUS_FK FOREIGN KEY (STATUS_FK) REFERENCES RENTAL_STATUS(STATUS_PK)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
